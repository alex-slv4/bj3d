...
export class ChipFactory {
    ...
    private getColorHex(value: number): string {
        ...
        switch (colorCode) {
            case ChipColor.BLUE: return "dark_blue";
            case ChipColor.RED: return "#f00";
            case ChipColor.GREEN: return "#0f0";
            case ChipColor.LIGHT_BLUE: return "#20beff";
            case ChipColor.PURPLE: return "#f0f";
            case ChipColor.ORANGE: return "#f90";
        }
        return "#000";
    }
